...
for x in range(0,len(rutas)):
    ...
    for recorrido in range(len(lista_archivos)):
        ...
        # Normal termination determination
        if entrada_1==True:
        ...
        # File search of atoms and values calculation
        if entrada_2==True:
            ...
            # Hirshfeld + hydrogens summed into heavy atoms
